...
def generate_readme(metadata_path: str = "metadata/semantic_index.json", output_path: str = "README.generated.md"): with open(metadata_path, "r", encoding="utf-8") as f: data = json.load(f)
