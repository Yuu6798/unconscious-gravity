...
class PoRModel:
    ...
    def is_por_null(
        ...
        """Returns True if none of the keywords appear in output"""
        lower = output.lower()
    ...
    def is_por_structure(
        ...
        """
        Returns True only if 'semantic', 'gravity', and 'resonance'
        are all present in the output text.
        """
        lower = output.lower()
        return all(w in lower for w in ["semantic", "gravity", "resonance"])