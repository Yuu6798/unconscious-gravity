...
import unittest from models.por_model import PoRModel

class TestPoRModelExtended(unittest.TestCase): def test_refire_difference_boundary(self): self.assertAlmostEqual( PoRModel.refire_difference(0.5001, 0.5), 0.0001, places=4 )
